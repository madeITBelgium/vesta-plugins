...
add_top_menu_item('WP-CLI', '/list?plugin=wpcli', true, "Plugin", 1, 'loadWPCliIndex');

function loadWPCliIndex() {
    $version = "";
        ...
        <div class="l-sort-toolbar clearfix">
          <table>
            <tr>
              ...
              <td>
                <form action="/list?plugin=wpcli" method="post" id="objects">
                <input type="hidden" name="token" value="<?=$_SESSION['token']?>" />
                <div class="l-select">
          ...
          <div class="l-unit-toolbar__col l-unit-toolbar__col--right noselect">
            <div class="actions-panel clearfix">
              <? if ($data[$key]['UPDATED'] == 'no') {
                   echo '<div class="actions-panel__col actions-panel__update shortcut-u" key-action="href"><a href="/list?plugin=wpcli&update='.$key.'&token='.$_SESSION['token'].'">'.__('update').'<i></i></a><span class="shortcut">&nbsp;U</span></div>';
                 }
              ?>
            </div>
            <!-- /.actiona-panel -->
